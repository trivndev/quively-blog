@if ($isDetail)
    <article
        class="mx-auto w-full max-w-7xl rounded-lg bg-white px-4 sm:px-8 lg:px-12 py-8 format format-sm format-blue dark:format-invert sm:format-base lg:format-lg">
