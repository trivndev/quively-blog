...
<div class="relative rounded-lg bg-white p-4 border sm:p-5 dark:bg-gray-800">
    ...
    <form class="space-y-4" action="/dashboard" method="post" id="blog-form">
        @csrf
        <div>
            <label for="title"
            ...
            <input type="text" name="title" id="title"
                   ...
                   placeholder="Type your blog title" value="{{old('title')}}">
            @error('title')
        ...
        <div class="sm:col-span-2"><label for="blog_content"
            ...
            <textarea id="blog_content" rows="4" name="blog_content"
                      ...
                      placeholder="Write blog content here">{{old('blog_content')}}</textarea>
            <div id="editor">
                {!! old('blog_content') !!}
            </div>
            @error('blog_content')
        ...
        <div class="ml-auto w-fit flex flex-wrap justify-center sm:justify-end items-center gap-2">
            ...
            <button type="submit"
                ...
                <svg class="-ml-1 mr-1 size-6" fill="currentColor" viewbox="0 0 20 20"
                     xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd"
