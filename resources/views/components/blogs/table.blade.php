<section class="mx-auto antialiased sm:p-3">
    <h2 class="mb-4 text-3xl font-bold sm:px-4">Your Blogs</h2>
    <div class="sm:px-4">
        <div class="relative overflow-hidden border bg-white rounded-lg dark:bg-gray-800">
            <div class="flex flex-col items-center justify-between space-y-3 p-4 md:flex-row md:space-x-4 md:space-y-0">
                <div class="w-full md:w-1/2">
                    <form class="flex items-center" autocomplete="off">
                        <label for="keyword" class="sr-only">Search blog</label>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left text-sm text-gray-500 dark:text-gray-400">
                        ...
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-3 text-center">Published At</th>
                            <th scope="col" class="w-0 max-w-fit px-4 py-3 text-center">
                        ...
                        @foreach ($posts as $post)
                            <tr class="border-b dark:border-gray-700">
                                <th scope="row"
                                    ...
                                    {{ $loop->iteration }}</th>
                                <td class="min-w-48 max-w-56 truncate px-4 py-3 text-center">{{ $post->title }}
                                </td>
                                <td class="px-4 py-3 text-center">{{ $post->category->name }}</td>
                                <td class="px-4 py-3 text-center">{{ $post->created_at->diffForHumans() }} </td>
                                <td class="flex max-w-fit items-center justify-center px-4 py-3">
                                    <button id="blog-{{ $post->id }}-dropdown-button"
                                            data-dropdown-toggle="blog-{{ $post->id }}-dropdown"
                                        ...
                                        <ul class="py-1 text-sm"
                                            ...
                                            <li>
                                                <button type="button" data-modal-target="deleteModal-{{ $post->id }}"
                                                    ...
                                                    <svg class="mr-2 h-4 w-4" viewbox="0 0 14 15" fill="none"
                                                         xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                                              fill="currentColor"
                                    ...
                                    <div id="deleteModal-{{ $post->id }}" tabindex="-1" aria-hidden="true"
                                        ...
                                        <div class="relative max-h-full w-full max-w-md p-4 z-50">
                                            <div
            ...
            @else
                <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
                    <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">
                        You don't have any blogs yet.</h1>
                    <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-400">
                        You can create a new blog by clicking the button below.</p>
                    <a href="/dashboard/create" title="Create a new blog"
        ...
        <div class="relative rounded-lg bg-white p-4 shadow sm:p-5 dark:bg-gray-800">
            ...
            <form action="#">
                <div class="mb-4 grid gap-4 sm:grid-cols-2">
                    ...
                    <div>
                        <label for="brand"
                               class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">Brand</label>
                    ...
                    <div><label for="category"
                                class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">Category</label><select
                            id="category"
