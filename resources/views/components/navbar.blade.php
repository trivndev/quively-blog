...
@endphp
<nav class="sticky top-0 isolate z-50" x-data="{ open: false, toggle() { this.open = !this.open } }">
                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            ...
                            @endif
                            <x-custom-nav-link class="block" href="/blog"
                                               :current="request()->is('blog') || request()->is('/')">
                                Blog
                            </x-custom-nav-link>
                        </div>
                    </div>
                                ...
                                @if ($signed_in)
                                    ...
                                    <div x-show="open" @click.outside="open = false"
                                        ...
                                        <div class="flex flex-col gap-0 border-b px-4 py-2">
                                            ...
                                            <p class="text-sm text-gray-500 w-full truncate">{{ Auth::user()->email }}</p>
                                        </div>
                                        <div>
